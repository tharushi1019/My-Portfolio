  ...
  const socialLinks = [
    {
      ...
      label: 'tharushinimnadee19@gmail.com',
      href: 'mailto:tharushinimnadee19@gmail.com',
      color: '#EA4335'
    },
    {
      name: 'LinkedIn',
      ...
      label: 'linkedin.com/in/t-nimnadi',
      href: 'https://www.linkedin.com/in/t-nimnadi/',
      color: '#0077B5'
    },
    {
      name: 'GitHub',
      ...
      <div className={styles.content}>
        ...
        <div className={styles.ctaSection}>
          <div className={styles.ctaCard}>
            ...
            <a href="mailto:tharushinimnadee19@gmail.com" className={styles.ctaButton}>
